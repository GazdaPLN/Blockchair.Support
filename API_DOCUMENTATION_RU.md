...
* **Рекомендации по производительности:** Для оптимальной производительности и экономии запросов используйте пакетные endpoints (например, `/bitcoin/dashboards/addresses/addr1,addr2,...` вместо множественных индивидуальных запросов), специализированные endpoints для проверки балансов (`/bitcoin/addresses/balances`), и параметр `?limit=` для ограничения объема возвращаемых данных. Подробнее см. в английской документации.
